...
from .resources import CountResource, AdminStudResource, AdminStudListResource, AdminCompResource, AdminCompListResource, AdminCompEditResource, AdminpdResource, AdminpdEditResource, AdminAppListResource, AdminPdListResource, AdminCompPendingListResource
