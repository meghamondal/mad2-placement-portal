...
from .resources import StudentResource, StudentpdListResource, StudentpdApplyResource, StudentAppHistoryResource

stud_api.add_resource(StudentResource, "/stud_details")
stud_api.add_resource(StudentpdListResource, "/stud_pdlist")
stud_api.add_resource(StudentpdApplyResource, "/stud_apply")
